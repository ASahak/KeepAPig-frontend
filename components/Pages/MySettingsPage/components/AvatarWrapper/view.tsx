...
const View: React.FC<ComponentViewPropsType> = ({ avatar, fileInputRef, triggerOnFile, fileChange, isUploading, deleteAvatar, isDeleting }) => (
  <Box>
    <Box display="flex" alignItems="center" justifyContent="center" width="full" height={150}>
    ...
    {!!avatar ? (
      <Button size="sm" mt={3} colorScheme="red" w="full" disabled={isDeleting} onClick={deleteAvatar}>
        Delete Avatar
      </Button>
    ) : null}
  </Box>
