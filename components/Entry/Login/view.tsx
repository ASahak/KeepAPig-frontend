          ...
          render={({ fieldState: { error }, field: { onChange, value } }) => (
            <FormControl mb={3}>
              ...
              <Input
                ...
                variant="whiteTinted"
              />
              <ErrorMessage errors={formState.errors} name="email" render={({ message }) => <Text size="sm" variant="errorMessage" colorScheme="red">{message}</Text>} />
            </FormControl>
          )}
        />
        <Controller
          ...
          render={({ fieldState: { error }, field: { onChange, value } }) => (
            <FormControl mb={3}>
              ...
              <Input
                ...
                variant="whiteTinted"
              />
              <ErrorMessage errors={formState.errors} name="password" render={({ message }) => <Text size="sm" variant="errorMessage" colorScheme="red">{message}</Text>} />
            </FormControl>
          )}
        />
        <Controller
