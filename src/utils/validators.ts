...
const Schema = {
    LOGIN_FORM: Yup.object().shape({
        email: Yup
            ...
            .email('Please write your email address in format: john.doe@example.com')
            .max(255),
        password: Yup
            .string()
            .required('Please complete this mandatory field')
            ...
            .matches(
                VALIDATORS.SYMBOL_PATTERN,
                'Password must contain at least one symbol'
            )
            .matches(
                VALIDATORS.DIGIT_PATTERN,
                'Password must contain at least one digit'
            )
            .matches(
                VALIDATORS.UPPERCASE_LOWERCASE_PATTERN,
            ...
            Yup.object().shape({
                ...
                fullName: Yup
                    ...
                    .matches(
                        ...
                        'Please write your name in format: John_Doe',
                    ),
            })
        )
    }
